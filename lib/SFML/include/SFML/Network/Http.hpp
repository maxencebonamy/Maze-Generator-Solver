...
public:
    ...
    public:
        ...
        ////////////////////////////////////////////////////////////
        /// \brief Set the value of a fields
        ///
        /// The fields is created if it doesn't exist. The name of
        /// the fields is case-insensitive.
        /// By default, a request doesn't contain any fields (but the
        /// mandatory fields are added later by the HTTP client when
        /// sending the request).
        ///
        /// \param field Name of the fields to set
        /// \param value Value of the fields
        ///
        ////////////////////////////////////////////////////////////
    ...
    private:
        ...
        ////////////////////////////////////////////////////////////
        /// \brief Check if the request defines a fields
        ///
        /// This function uses case-insensitive comparisons.
        ///
        /// \param field Name of the fields to test
        ///
        /// \return True if the fields exists, false otherwise
        ///
        ////////////////////////////////////////////////////////////
    ...
    public:
        ...
        enum Status
        {
            ...
            RangeNotSatisfiable = 407, ///< The server can't satisfy the partial GET request (with a "Range" header fields)
        ...
        ////////////////////////////////////////////////////////////
        /// \brief Get the value of a fields
        ///
        /// If the fields \a fields is not found in the response header,
        /// the empty string is returned. This function uses
        /// case-insensitive comparisons.
        ///
        /// \param field Name of the fields to get
        ///
        /// \return Value of the fields, or empty string if not found
        ///
        ////////////////////////////////////////////////////////////
    ...
    /// Any missing mandatory header fields in the request will be added
